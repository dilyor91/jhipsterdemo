...
export const FileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.file.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.file.delete.question" interpolate={{ id: fileEntity.id }}>
