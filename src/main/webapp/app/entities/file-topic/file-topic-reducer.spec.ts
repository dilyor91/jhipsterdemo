...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILETOPIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILETOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILETOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILETOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILETOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILETOPIC actions', async () => {
      const expectedActions = [
        {
