...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './greeting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GREETING_LIST actions', async () => {
    ...
    it('dispatches FETCH_GREETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GREETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GREETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GREETING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GREETING actions', async () => {
      const expectedActions = [
        {
