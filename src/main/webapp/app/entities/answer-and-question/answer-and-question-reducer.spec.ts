...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './answer-and-question.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANSWERANDQUESTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANSWERANDQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANSWERANDQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANSWERANDQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANSWERANDQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANSWERANDQUESTION actions', async () => {
      const expectedActions = [
        {
