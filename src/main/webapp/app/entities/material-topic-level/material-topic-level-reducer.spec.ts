...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './material-topic-level.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIALTOPICLEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIALTOPICLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIALTOPICLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIALTOPICLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIALTOPICLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIALTOPICLEVEL actions', async () => {
      const expectedActions = [
        {
