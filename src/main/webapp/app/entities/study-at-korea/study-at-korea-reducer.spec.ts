...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDYATKOREA_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDYATKOREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDYATKOREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDYATKOREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDYATKOREA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDYATKOREA actions', async () => {
      const expectedActions = [
        {
