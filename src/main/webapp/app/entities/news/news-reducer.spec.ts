...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './news.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NEWS_LIST actions', async () => {
    ...
    it('dispatches FETCH_NEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NEWS actions', async () => {
      const expectedActions = [
        {
