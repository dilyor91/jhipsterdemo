...
export const BannerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.banner.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.banner.delete.question" interpolate={{ id: bannerEntity.id }}>
