...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './logo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGO actions', async () => {
      const expectedActions = [
        {
