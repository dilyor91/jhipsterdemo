...
export const EventsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.events.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.events.delete.question" interpolate={{ id: eventsEntity.id }}>
