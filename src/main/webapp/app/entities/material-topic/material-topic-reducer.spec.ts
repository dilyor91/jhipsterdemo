...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIALTOPIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIALTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIALTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIALTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIALTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIALTOPIC actions', async () => {
      const expectedActions = [
        {
