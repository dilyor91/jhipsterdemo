...
export const AlbumDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.album.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.album.delete.question" interpolate={{ id: albumEntity.id }}>
