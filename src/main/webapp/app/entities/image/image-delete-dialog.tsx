...
export const ImageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.image.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.image.delete.question" interpolate={{ id: imageEntity.id }}>
