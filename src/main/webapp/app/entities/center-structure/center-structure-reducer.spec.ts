...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CENTERSTRUCTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CENTERSTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CENTERSTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CENTERSTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CENTERSTRUCTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CENTERSTRUCTURE actions', async () => {
      const expectedActions = [
        {
