...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OURHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_OURHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OURHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OURHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OURHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OURHISTORY actions', async () => {
      const expectedActions = [
        {
