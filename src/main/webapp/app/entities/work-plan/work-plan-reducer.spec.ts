...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './work-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKPLAN actions', async () => {
      const expectedActions = [
        {
